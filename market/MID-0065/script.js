...
// ── Sound ──
const SPEECH_TEXT = 'VirusPredict AI. Epidemic prediction and pandemic preparedness AI. Category: Biological. Price: 1299.0 dollars per yearly. Accuracy: 87% outbreak prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0065';}
