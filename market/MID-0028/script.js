...
// ── Sound ──
const SPEECH_TEXT = 'SecurityCodeAI. Security-focused code generator that eliminates OWASP vulnerabilities. Category: Code Generation. Price: 149.0 dollars per monthly. Accuracy: 99.1%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0028';}
