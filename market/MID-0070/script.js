...
// ── Sound ──
const SPEECH_TEXT = 'PlantGenome AI. Crop improvement AI for yield optimization and disease resistance. Category: Biological. Price: 699.0 dollars per yearly. Accuracy: 91% phenotype prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0070';}
