...
// ── Sound ──
const SPEECH_TEXT = 'EmailGenius AI. Intelligent email drafting and response automation. Category: Language Model. Price: 35.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0016';}
