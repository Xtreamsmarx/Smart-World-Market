...
// ── Sound ──
const SPEECH_TEXT = 'CloudGuard AI. Cloud security posture management with autonomous remediation. Category: Cybersecurity. Price: 249.0 dollars per monthly. Accuracy: 99.3%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0087';}
