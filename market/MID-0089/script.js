...
// ── Sound ──
const SPEECH_TEXT = 'InsuranceRisk AI. AI underwriting and actuarial risk modeling for insurance. Category: Financial AI. Price: 349.0 dollars per monthly. Accuracy: 94% actuarial accuracy.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0089';}
