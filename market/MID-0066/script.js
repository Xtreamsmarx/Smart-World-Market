...
// ── Sound ──
const SPEECH_TEXT = 'CRISPRdesign AI. CRISPR guide RNA design and off-target prediction AI. Category: Biological. Price: 4999.0 dollars per yearly. Accuracy: 40% efficiency gain.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0066';}
