...
// ── Sound ──
const SPEECH_TEXT = 'StoryForge AI. Creative story and content generation for novels, scripts, and games. Category: Language Model. Price: 45.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0014';}
