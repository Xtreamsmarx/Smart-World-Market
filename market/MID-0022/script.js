...
// ── Sound ──
const SPEECH_TEXT = 'ArchViz AI. Architectural visualization from floor plans and design briefs. Category: Image Generation. Price: 129.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0022';}
