...
// ── Sound ──
const SPEECH_TEXT = 'ArchitectAI Design. AI architect that designs buildings from brief to construction drawings. Category: Human Services. Price: 499.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0076';}
