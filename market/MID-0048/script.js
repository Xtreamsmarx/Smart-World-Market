...
// ── Sound ──
const SPEECH_TEXT = 'CryptoAnalyze AI. On-chain crypto analytics and DeFi risk assessment. Category: Financial AI. Price: 179.0 dollars per monthly. Accuracy: 76% prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0048';}
