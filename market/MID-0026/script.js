...
// ── Sound ──
const SPEECH_TEXT = 'DocWriter AI. Auto-generates API docs, READMEs, and technical documentation. Category: Code Generation. Price: 45.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0026';}
