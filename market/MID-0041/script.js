...
// ── Sound ──
const SPEECH_TEXT = 'DrugInteract AI. Drug interaction checker and medication safety AI for healthcare. Category: Healthcare AI. Price: 199.0 dollars per monthly. Accuracy: 99.2%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0041';}
