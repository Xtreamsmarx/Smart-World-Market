...
// ── Sound ──
const SPEECH_TEXT = 'ObjectEye Vision. Real-time object detection and tracking for 10,000+ classes at 120 FPS. Category: Computer Vision. Price: 89.0 dollars per monthly. Accuracy: 96.1% mAP.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0008';}
