...
// ── Sound ──
const SPEECH_TEXT = 'PersonaClone AI. Digital twin AI that recreates a person\'s knowledge and communication style. Category: Human Services. Price: 499.0 dollars per monthly. Accuracy: 91% style matching.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0096';}
