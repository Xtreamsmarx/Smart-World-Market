...
// ── Sound ──
const SPEECH_TEXT = 'MatterFabricate AI. Molecular design AI for advanced materials and nanotechnology. Category: Biological. Price: 2499.0 dollars per yearly. Accuracy: 84% property prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0099';}
