...
// ── Sound ──
const SPEECH_TEXT = 'ScienceLM AI. Scientific research assistant for papers, hypotheses, and data interpretation. Category: Language Model. Price: 249.0 dollars per monthly. Accuracy: 94.8%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0017';}
