...
// ── Sound ──
const SPEECH_TEXT = 'OceanSense AI. Ocean health monitoring and marine ecosystem intelligence AI. Category: Climate & Environment. Price: 599.0 dollars per monthly. Accuracy: 93% species ID.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0081';}
