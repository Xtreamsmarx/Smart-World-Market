...
// ── Sound ──
const SPEECH_TEXT = 'SpeechClean AI. Real-time speech enhancement and noise removal. Category: Voice & Audio. Price: 59.0 dollars per monthly. Accuracy: 98.2%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0031';}
