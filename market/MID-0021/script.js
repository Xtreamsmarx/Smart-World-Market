...
// ── Sound ──
const SPEECH_TEXT = 'UIDesigner AI. Automatic UI/UX design generation from wireframes and descriptions. Category: Image Generation. Price: 89.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0021';}
