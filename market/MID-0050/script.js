...
// ── Sound ──
const SPEECH_TEXT = 'WeldBot AI. AI-powered adaptive welding control for precision manufacturing. Category: Robotics. Price: 799.0 dollars per monthly. Accuracy: 99.6%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0050';}
