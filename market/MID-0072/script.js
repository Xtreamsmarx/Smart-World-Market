...
// ── Sound ──
const SPEECH_TEXT = 'SkillForge AI. Personalized skill development and microlearning AI coach. Category: Human Services. Price: 59.0 dollars per monthly. Accuracy: 60% faster learning.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0072';}
