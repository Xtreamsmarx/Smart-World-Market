...
// ── Sound ──
const SPEECH_TEXT = 'VulnScan AI. AI vulnerability scanner for web apps, APIs, and cloud infrastructure. Category: Cybersecurity. Price: 199.0 dollars per monthly. Accuracy: 96.8%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0054';}
