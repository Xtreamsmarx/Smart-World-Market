...
// ── Sound ──
const SPEECH_TEXT = 'AnomalyWatch AI. Real-time anomaly detection for IoT, manufacturing, and business data. Category: Data Analysis. Price: 129.0 dollars per monthly. Accuracy: 97.8%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0038';}
