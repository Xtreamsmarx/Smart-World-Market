...
// ── Sound ──
const SPEECH_TEXT = 'AsteroidTrack AI. Near-Earth asteroid detection and impact risk assessment. Category: Space Tech. Price: 1999.0 dollars per monthly. Accuracy: 99.8% detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0079';}
