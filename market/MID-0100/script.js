...
// ── Sound ──
const SPEECH_TEXT = 'UniversalAGI Alpha. First commercially available general intelligence AI system. Category: Language Model. Price: 9999.0 dollars per monthly. Accuracy: 96.8% general benchmark.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0100';}
