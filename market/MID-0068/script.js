...
// ── Sound ──
const SPEECH_TEXT = 'NeuronMap AI. Connectome analysis and neural circuit mapping AI. Category: Biological. Price: 2499.0 dollars per yearly. Accuracy: 98.5% neuron segmentation.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0068';}
