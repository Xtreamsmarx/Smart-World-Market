...
// ── Sound ──
const SPEECH_TEXT = 'TradeSense AI. AI-powered financial market prediction with 78% backtested accuracy. Category: Financial AI. Price: 399.0 dollars per monthly. Accuracy: 78% prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0007';}
