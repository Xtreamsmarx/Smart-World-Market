...
// ── Sound ──
const SPEECH_TEXT = 'MindWell AI. Mental health support AI with CBT-based interventions. Category: Healthcare AI. Price: 99.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0043';}
