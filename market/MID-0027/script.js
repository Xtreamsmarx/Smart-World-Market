...
// ── Sound ──
const SPEECH_TEXT = 'APIDesign AI. AI that designs and implements RESTful and GraphQL APIs. Category: Code Generation. Price: 99.0 dollars per monthly. Accuracy: 93.2%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0027';}
