...
// ── Sound ──
const SPEECH_TEXT = 'SentimentIQ. Multi-lingual sentiment and emotion analysis for 60+ languages. Category: Data Analysis. Price: 39.0 dollars per monthly. Accuracy: 93.8%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0009';}
