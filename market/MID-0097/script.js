...
// ── Sound ──
const SPEECH_TEXT = 'SocietyModel AI. Agent-based social simulation for policy analysis and urban planning. Category: Human Services. Price: 899.0 dollars per monthly. Accuracy: 87% policy outcome prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0097';}
