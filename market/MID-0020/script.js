...
// ── Sound ──
const SPEECH_TEXT = 'LogoMaster AI. Brand identity AI that creates logos, icons, and visual identities. Category: Image Generation. Price: 59.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0020';}
