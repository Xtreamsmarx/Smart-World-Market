...
// ── Sound ──
const SPEECH_TEXT = 'FaceAuth Pro. Biometric face recognition and liveness detection for security systems. Category: Computer Vision. Price: 199.0 dollars per monthly. Accuracy: 99.97%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0034';}
