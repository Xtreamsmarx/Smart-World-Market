...
// ── Sound ──
const SPEECH_TEXT = 'PatientRisk AI. Predictive patient risk scoring for hospital readmission and deterioration. Category: Healthcare AI. Price: 349.0 dollars per monthly. Accuracy: 87% AUC.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0042';}
