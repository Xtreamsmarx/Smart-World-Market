...
// ── Sound ──
const SPEECH_TEXT = 'SpaceWeather AI. Solar storm prediction and space weather forecasting AI. Category: Space Tech. Price: 999.0 dollars per monthly. Accuracy: 94% prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0077';}
