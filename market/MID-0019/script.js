...
// ── Sound ──
const SPEECH_TEXT = 'PhotoRestore AI. AI-powered photo restoration and enhancement for old and damaged images. Category: Image Generation. Price: 49.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0019';}
