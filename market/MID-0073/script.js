...
// ── Sound ──
const SPEECH_TEXT = 'LegalAdvisor AI. Instant legal guidance for contracts, rights, and disputes. Category: Human Services. Price: 299.0 dollars per monthly. Accuracy: 94.2%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0073';}
