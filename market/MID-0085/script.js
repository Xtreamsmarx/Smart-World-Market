...
// ── Sound ──
const SPEECH_TEXT = 'SwarmControl AI. Intelligent swarm robotics coordination for construction and mining. Category: Robotics. Price: 699.0 dollars per monthly. Accuracy: 99.9% task completion.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0085';}
