...
// ── Sound ──
const SPEECH_TEXT = 'InvoiceProcess AI. Automated invoice processing and accounts payable AI. Category: Financial AI. Price: 89.0 dollars per monthly. Accuracy: 98% STP.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0046';}
