...
// ── Sound ──
const SPEECH_TEXT = 'PhishBlock AI. Email phishing detection and social engineering prevention. Category: Cybersecurity. Price: 79.0 dollars per monthly. Accuracy: 99.7%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0053';}
