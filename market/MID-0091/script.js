...
// ── Sound ──
const SPEECH_TEXT = 'NeuroBCI AI. Brain-computer interface AI for motor control and communication. Category: Biological. Price: 1999.0 dollars per monthly. Accuracy: 94% intent decoding.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0091';}
