...
// ── Sound ──
const SPEECH_TEXT = 'ForecastEngine AI. Demand forecasting and time-series prediction for any business metric. Category: Data Analysis. Price: 199.0 dollars per monthly. Accuracy: MAPE < 5%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0039';}
