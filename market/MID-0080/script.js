...
// ── Sound ──
const SPEECH_TEXT = 'ClimateModel AI. High-resolution climate modeling and extreme weather prediction. Category: Climate & Environment. Price: 799.0 dollars per monthly. Accuracy: 92% weather prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0080';}
