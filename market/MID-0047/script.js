...
// ── Sound ──
const SPEECH_TEXT = 'CreditRisk AI. Alternative credit scoring using 1500+ data signals. Category: Financial AI. Price: 149.0 dollars per monthly. Accuracy: 85% default prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0047';}
