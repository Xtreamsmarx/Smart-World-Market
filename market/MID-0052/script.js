...
// ── Sound ──
const SPEECH_TEXT = 'ThreatIntel AI. AI-powered threat intelligence aggregating 5000+ security feeds. Category: Cybersecurity. Price: 299.0 dollars per monthly. Accuracy: 94.3% prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0052';}
