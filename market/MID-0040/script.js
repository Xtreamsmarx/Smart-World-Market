...
// ── Sound ──
const SPEECH_TEXT = 'ReportBot AI. Automated business report generation from raw data. Category: Data Analysis. Price: 79.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0040';}
