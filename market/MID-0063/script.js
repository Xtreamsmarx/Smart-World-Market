...
// ── Sound ──
const SPEECH_TEXT = 'DrugSynth AI. De novo drug molecule design and synthesis pathway optimization. Category: Biological. Price: 3999.0 dollars per yearly. Accuracy: 87% active hit rate.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0063';}
