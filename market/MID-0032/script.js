...
// ── Sound ──
const SPEECH_TEXT = 'AudioBook AI. Converts any text to audiobook with professional narration. Category: Voice & Audio. Price: 89.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0032';}
