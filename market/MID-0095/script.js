...
// ── Sound ──
const SPEECH_TEXT = 'WaterSense AI. Water quality monitoring and contamination prediction AI. Category: Climate & Environment. Price: 299.0 dollars per monthly. Accuracy: 99.2% contamination detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0095';}
