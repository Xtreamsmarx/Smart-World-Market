...
// ── Sound ──
const SPEECH_TEXT = 'MusicCompose AI. AI composer generating royalty-free music in any style and mood. Category: Voice & Audio. Price: 149.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0030';}
