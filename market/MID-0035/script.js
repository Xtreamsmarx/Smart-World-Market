...
// ── Sound ──
const SPEECH_TEXT = 'QualityVision AI. Industrial quality control AI detecting defects at microscopic level. Category: Computer Vision. Price: 179.0 dollars per monthly. Accuracy: 99.9%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0035';}
