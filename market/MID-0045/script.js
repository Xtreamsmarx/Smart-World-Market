...
// ── Sound ──
const SPEECH_TEXT = 'FraudGuard AI. Real-time payment fraud detection with <0.1% false positive rate. Category: Financial AI. Price: 249.0 dollars per monthly. Accuracy: 99.92%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0045';}
