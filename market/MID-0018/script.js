...
// ── Sound ──
const SPEECH_TEXT = 'PolyglotAI. Real-time multi-language conversation AI for 120+ languages. Category: Language Model. Price: 55.0 dollars per monthly. Accuracy: 92.3%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0018';}
