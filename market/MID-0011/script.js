...
// ── Sound ──
const SPEECH_TEXT = 'TranslateX. Neural machine translation for 200+ language pairs with near-human accuracy. Category: Language Model. Price: 29.0 dollars per monthly. Accuracy: 91.2% BLEU.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0011';}
