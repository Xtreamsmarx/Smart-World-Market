...
// ── Sound ──
const SPEECH_TEXT = 'ForensicAI. Digital forensics AI for cyber incident investigation. Category: Cybersecurity. Price: 399.0 dollars per monthly. Accuracy: 96.2%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0086';}
