...
// ── Sound ──
const SPEECH_TEXT = 'PodcastPro AI. Full podcast production AI — scripts, audio editing, and publishing. Category: Voice & Audio. Price: 79.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0029';}
