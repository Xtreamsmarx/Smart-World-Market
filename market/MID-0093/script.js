...
// ── Sound ──
const SPEECH_TEXT = 'TelepathyNet AI. Neural language AI for augmenting human-to-human communication. Category: Human Services. Price: 129.0 dollars per monthly. Accuracy: 88% emotion detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0093';}
