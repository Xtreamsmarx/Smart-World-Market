...
// ── Sound ──
const SPEECH_TEXT = 'BioMarker AI. Multi-omic biomarker discovery for disease and drug response. Category: Biological. Price: 1799.0 dollars per yearly. Accuracy: 92% validation rate.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0064';}
