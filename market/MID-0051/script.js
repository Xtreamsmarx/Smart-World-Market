...
// ── Sound ──
const SPEECH_TEXT = 'DroneAI Navigate. Autonomous drone navigation and swarm coordination AI. Category: Robotics. Price: 299.0 dollars per monthly. Accuracy: 99.95% collision-free.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0051';}
