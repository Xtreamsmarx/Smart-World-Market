...
// ── Sound ──
const SPEECH_TEXT = 'GenomeDecoder AI. Whole genome sequencing analysis and variant interpretation. Category: Biological. Price: 2999.0 dollars per yearly. Accuracy: 99.9% variant calling.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0061';}
