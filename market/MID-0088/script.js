...
// ── Sound ──
const SPEECH_TEXT = 'ZeroTrust AI. Zero-trust network access AI with continuous identity verification. Category: Cybersecurity. Price: 449.0 dollars per monthly. Accuracy: 99.7%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0088';}
