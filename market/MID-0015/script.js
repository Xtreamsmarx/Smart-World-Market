...
// ── Sound ──
const SPEECH_TEXT = 'LegalLM Pro. Legal AI for contract analysis, case research, and compliance. Category: Language Model. Price: 299.0 dollars per monthly. Accuracy: 96.1%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0015';}
