...
// ── Sound ──
const SPEECH_TEXT = 'HapticSuit AI. Full-body haptic feedback suit for VR/AR immersion with AI adaptation. Category: Physical Hardware. Price: 2499.0 dollars per one-time. Accuracy: 150 haptic zones.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0060';}
