...
// ── Sound ──
const SPEECH_TEXT = 'CodeGen Ultra. Next-gen code generation supporting 50+ programming languages. Category: Code Generation. Price: 49.0 dollars per monthly. Accuracy: 94.7%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0002';}
