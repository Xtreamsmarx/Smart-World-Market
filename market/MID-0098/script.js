...
// ── Sound ──
const SPEECH_TEXT = 'ExoplanetAI. Exoplanet detection and habitability analysis AI. Category: Space Tech. Price: 799.0 dollars per monthly. Accuracy: 97.8% transit detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0098';}
