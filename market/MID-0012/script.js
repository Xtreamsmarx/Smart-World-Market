...
// ── Sound ──
const SPEECH_TEXT = 'SecureNet AI. Real-time cybersecurity threat detection with 99.98% accuracy. Category: Cybersecurity. Price: 249.0 dollars per monthly. Accuracy: 99.98%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0012';}
