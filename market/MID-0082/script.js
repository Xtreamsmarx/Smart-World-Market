...
// ── Sound ──
const SPEECH_TEXT = 'EarthWatch AI. Real-time Earth observation AI for disaster response and land monitoring. Category: Climate & Environment. Price: 499.0 dollars per monthly. Accuracy: 96.3%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0082';}
