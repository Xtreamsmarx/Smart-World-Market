...
// ── Sound ──
const SPEECH_TEXT = 'HarvestBot AI. Precision agriculture AI for crop monitoring and automated harvesting. Category: Robotics. Price: 549.0 dollars per monthly. Accuracy: 97% ripeness detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0083';}
