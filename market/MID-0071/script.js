...
// ── Sound ──
const SPEECH_TEXT = 'CareerPath AI. AI career counselor for job matching, skill gaps, and career transitions. Category: Human Services. Price: 79.0 dollars per monthly. Accuracy: 87% job match satisfaction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0071';}
