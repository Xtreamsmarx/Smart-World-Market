...
// ── Sound ──
const SPEECH_TEXT = 'EdgeAI Module. Plug-and-play AI inference hardware for edge deployment. Category: Physical Hardware. Price: 499.0 dollars per one-time. Accuracy: 100 TOPS.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0055';}
