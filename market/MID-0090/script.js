...
// ── Sound ──
const SPEECH_TEXT = 'M&A Predict AI. Merger and acquisition target identification and valuation AI. Category: Financial AI. Price: 599.0 dollars per monthly. Accuracy: 81% deal success prediction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0090';}
