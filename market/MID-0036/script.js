...
// ── Sound ──
const SPEECH_TEXT = 'SatelliteAI. Satellite imagery analysis for agriculture, construction, and environment. Category: Computer Vision. Price: 499.0 dollars per monthly. Accuracy: 95.6%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0036';}
