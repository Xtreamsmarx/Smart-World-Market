...
// ── Sound ──
const SPEECH_TEXT = 'TestWriter AI. Automatic unit, integration, and E2E test generation. Category: Code Generation. Price: 55.0 dollars per monthly. Accuracy: 91.3%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0025';}
