...
// ── Sound ──
const SPEECH_TEXT = 'SyntheticBio AI. Metabolic pathway engineering AI for synthetic biology. Category: Biological. Price: 2999.0 dollars per yearly. Accuracy: 89% success rate.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0092';}
