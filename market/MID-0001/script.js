...
// ── Sound ──
const SPEECH_TEXT = 'MedVision Pro. Advanced medical imaging AI for early disease detection. Category: Healthcare AI. Price: 299.0 dollars per monthly. Accuracy: 97.3%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0001';}
