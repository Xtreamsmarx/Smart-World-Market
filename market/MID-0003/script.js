...
// ── Sound ──
const SPEECH_TEXT = 'VoiceClone AI. Ultra-realistic voice synthesis and cloning from 3 seconds of audio. Category: Voice & Audio. Price: 99.0 dollars per monthly. Accuracy: 99.1%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0003';}
