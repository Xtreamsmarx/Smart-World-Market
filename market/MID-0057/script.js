...
// ── Sound ──
const SPEECH_TEXT = 'NeuralCamera Pro. AI-native camera with on-device computer vision processing. Category: Physical Hardware. Price: 1299.0 dollars per one-time. Accuracy: < 0.1mm measurement.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0057';}
