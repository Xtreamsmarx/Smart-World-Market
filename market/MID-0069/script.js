...
// ── Sound ──
const SPEECH_TEXT = 'BioAge AI. Biological age measurement and longevity optimization AI. Category: Biological. Price: 799.0 dollars per yearly. Accuracy: ±1.8 year accuracy.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0069';}
