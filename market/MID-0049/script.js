...
// ── Sound ──
const SPEECH_TEXT = 'PickBot AI. AI pick-and-place robotics for warehouse and e-commerce fulfillment. Category: Robotics. Price: 449.0 dollars per monthly. Accuracy: 99.98%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0049';}
