...
// ── Sound ──
const SPEECH_TEXT = 'ArtForge X. Professional-grade AI image generation from text prompts. Category: Image Generation. Price: 79.0 dollars per monthly. Accuracy: 96.8%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0004';}
