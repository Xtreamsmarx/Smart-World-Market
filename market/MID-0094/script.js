...
// ── Sound ──
const SPEECH_TEXT = 'EnergyOpt AI. AI energy management for smart grids and renewable optimization. Category: Climate & Environment. Price: 399.0 dollars per monthly. Accuracy: 28% waste reduction.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0094';}
