...
// ── Sound ──
const SPEECH_TEXT = 'ContextBridge AI. Long-context language model with 500K token window for complex documents. Category: Language Model. Price: 89.0 dollars per monthly. Accuracy: 93.5%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0013';}
