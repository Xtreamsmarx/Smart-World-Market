...
// ── Sound ──
const SPEECH_TEXT = 'DocDigitize AI. OCR and document understanding for any paper or digital document. Category: Computer Vision. Price: 79.0 dollars per monthly. Accuracy: 99.5% OCR.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0037';}
