...
// ── Sound ──
const SPEECH_TEXT = 'MicrobiomeAI. Gut microbiome analysis for health, nutrition, and disease risk. Category: Biological. Price: 399.0 dollars per yearly. Accuracy: 89% prediction accuracy.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0067';}
