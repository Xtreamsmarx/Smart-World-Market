...
// ── Sound ──
const SPEECH_TEXT = 'CleanBot AI. Autonomous cleaning and sanitization robot AI for public spaces. Category: Robotics. Price: 249.0 dollars per monthly. Accuracy: 99% coverage.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0084';}
