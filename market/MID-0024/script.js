...
// ── Sound ──
const SPEECH_TEXT = 'BugHunter AI. Automated bug detection and vulnerability scanning for codebases. Category: Code Generation. Price: 69.0 dollars per monthly. Accuracy: 89% detection.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0024';}
