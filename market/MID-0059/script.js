...
// ── Sound ──
const SPEECH_TEXT = 'QuantumChip AI. Quantum-classical hybrid AI accelerator for research and enterprise. Category: Physical Hardware. Price: 49999.0 dollars per one-time. Accuracy: Quantum advantage.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0059';}
