...
// ── Sound ──
const SPEECH_TEXT = 'SatelliteOps AI. Autonomous satellite operations and constellation management AI. Category: Space Tech. Price: 4999.0 dollars per monthly. Accuracy: 99.99% availability.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0078';}
