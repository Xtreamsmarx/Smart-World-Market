...
// ── Sound ──
const SPEECH_TEXT = 'SmartSensor AI. AI-integrated environmental sensor array with edge processing. Category: Physical Hardware. Price: 799.0 dollars per one-time. Accuracy: 99.1%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0056';}
