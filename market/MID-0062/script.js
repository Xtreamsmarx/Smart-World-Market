...
// ── Sound ──
const SPEECH_TEXT = 'ProteinFold AI. Protein structure prediction and drug binding site analysis. Category: Biological. Price: 1499.0 dollars per yearly. Accuracy: < 1Å RMSD.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0062';}
