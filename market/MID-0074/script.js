...
// ── Sound ──
const SPEECH_TEXT = 'LanguageTutor AI. Immersive AI language tutor with native-level conversation practice. Category: Human Services. Price: 49.0 dollars per monthly. Accuracy: 3x faster fluency.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0074';}
