...
// ── Sound ──
const SPEECH_TEXT = 'MindCoach AI. Executive coaching and peak performance AI for leaders. Category: Human Services. Price: 199.0 dollars per monthly. Accuracy: N/A.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0075';}
