...
// ── Sound ──
const SPEECH_TEXT = 'RoboCore AI. Advanced reinforcement learning for robotics control and motion planning. Category: Robotics. Price: 599.0 dollars per monthly. Accuracy: 98.7%.';
let _speaking=false;
...
// ── Buy button ──
function goBuy(){window.location.href='/payment/MID-0010';}
